...
export const AUTH_TOKEN = 'litetracker.auth';
export const LOCALE_CONFIG = 'litetracker.locale';
export const TIMEZONE_CONFIG = 'litetracker.timezone';
export const DATE_RANGE_CONFIG = 'litetracker.date-range';
export const THEME_CONFIG = 'litetracker.theme';
export const DASHBOARD_CONFIG = 'litetracker.dashboard';
export const LAST_TEAM_CONFIG = 'litetracker.last-team';
export const VERSION_CHECK = 'litetracker.version-check';
export const SHARE_TOKEN_HEADER = 'x-litetracker-share-token';
export const HOMEPAGE_URL = 'https://yourdomain.com';
export const DOCS_URL = 'https://yourdomain.com/docs';
export const REPO_URL = 'https://github.com/Surendhirang/litetracker';
...
export const PIXELS_URL = `${globalThis?.location?.origin}/p`;                 // ← keep as-is
